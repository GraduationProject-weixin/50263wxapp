...
## 1.2 课题意义 
现如今，信息种类变得越来越多，信息的容量也变得越来越大，这就是信息时代的标志。近些年，计算机科学发展得也越来越快，而且软件开发技术也越来越成熟，因此，在生活中的各个领域，只要存在信息管理，几乎都有计算机的影子，可以说很多行业都采用计算机的方式管理信息。信息计算机化处理相比手工操作，有着保密性强，效率高，存储空间大，成本低等诸多优点。针对高校教师成果信息管理，采用微信小程序跑腿平台可以有效管理，使信息管理能够更加科学和规范。

总之，在实际中使用微信小程序跑腿平台，其意义如下：

第一点：微信小程序跑腿平台的实际运用，可以帮助管理人员在短时间内完成信息处理工作；
...
第四点：可以降低信息管理成本；
## 1.3 研究内容
对微信小程序跑腿平台设计制作，不仅需要技术支撑，也需要大量的理论研究。本文在对微信小程序跑腿平台进行介绍时，将按照如下内容进行。

第一部分：介绍微信小程序跑腿平台研究的背景意义，便于用户了解系统；

第二部分：介绍开发微信小程序跑腿平台需要搭建的环境，包括技术和工具；

第三部分：介绍用户对微信小程序跑腿平台的功能要求，以及对微信小程序跑腿平台的性能要求等；
...
# 第2章 开发环境与技术
微信小程序跑腿平台的编码实现需要搭建一定的环境和使用相应的技术，接下来的内容就是对微信小程序跑腿平台用到的技术和工具进行介绍。
## 2.1 MYSQL数据库
...
### 3.1.2 经济可行性
本系统开发期间需要配置的软件环境，可以免费通过开发类官网下载安装，需要配置的硬件设备也不需要具备很高的性能，通常网吧电脑，或学校计算机机房的电脑都符合要求。因此，从经济方面考虑，微信小程序跑腿平台开发可行。
### 3.1.3 操作可行性
微信小程序跑腿平台根据用户使用习惯进行开发，设计的界面具有统一性，并具备优秀的导航功能。所以，只要会简单操作电脑的人员，可以无压力操作微信小程序跑腿平台。
...
![C:\Users\Administrator\Desktop\img\weixnpaotuipingtai\用户.jpg](/md/blog.006.jpeg "C:\Users\Administrator\Desktop\img\weixnpaotuipingtai\用户.jpg")
图4.1 用户实体属性图

（2）下图是跑腿任务实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\weixnpaotuipingtai\跑腿任务.jpg](/md/blog.007.jpeg "C:\Users\Administrator\Desktop\img\weixnpaotuipingtai\跑腿任务.jpg")
图4.2 跑腿任务实体属性图

（3）下图是公告信息实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\weixnpaotuipingtai\公告信息.jpg](/md/blog.008.jpeg "C:\Users\Administrator\Desktop\img\weixnpaotuipingtai\公告信息.jpg")
图4.3 公告信息实体属性图

（4）下图是字典表实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\weixnpaotuipingtai\字典表.jpg](/md/blog.009.jpeg "C:\Users\Administrator\Desktop\img\weixnpaotuipingtai\字典表.jpg")
图4.4 字典表实体属性图

（5）下图是接单详情实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\weixnpaotuipingtai\接单详情.jpg](/md/blog.010.jpeg "C:\Users\Administrator\Desktop\img\weixnpaotuipingtai\接单详情.jpg")
图4.5 接单详情实体属性图

（6）下图是用户表实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\weixnpaotuipingtai\用户表.jpg](/md/blog.011.jpeg "C:\Users\Administrator\Desktop\img\weixnpaotuipingtai\用户表.jpg")
图4.6 用户表实体属性图

（7）下图是跑腿员实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\weixnpaotuipingtai\跑腿员.jpg](/md/blog.012.jpeg "C:\Users\Administrator\Desktop\img\weixnpaotuipingtai\跑腿员.jpg")
图4.7 跑腿员实体属性图

（8）下图是跑腿员评论实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\weixnpaotuipingtai\跑腿员评论.jpg](/md/blog.013.jpeg "C:\Users\Administrator\Desktop\img\weixnpaotuipingtai\跑腿员评论.jpg")
图4.8 跑腿员评论实体属性图
...
| :-: | :-: | :-: | :-: | :-: |
|1|Id|Int|id|否|
|2|paotuirenwu\_id|Integer|任务|是|
|3|jiedanyuan\_id|Integer|跑腿员|是|
|4|jiedanxiangqing\_status\_types|Integer|接单状态|是|
...
| :-: | :-: | :-: | :-: | :-: |
|1|Id|Int|id|否|
|2|jiedanyuan\_name|String|跑腿员姓名|是|
|3|jiedanyuan\_photo|String|头像|是|
|4|jiedanyuan\_phone|String|联系方式|是|
|5|jiedanyuan\_email|String|邮箱|是|
|6|new\_money|BigDecimal|工资|是|
...
| :-: | :-: | :-: | :-: | :-: |
|1|Id|Int|id|否|
|2|jiedanyuan\_id|Integer|跑腿员|是|
|3|yonghu\_id|Integer|用户|是|
|4|jiedanyuan\_liuyan\_text|String|评论内容|是|
...
| :-: | :-: | :-: | :-: | :-: |
|1|Id|Int|id|否|
|2|paotuirenwu\_uuid\_number|String|任务编号|是|
|3|paotuirenwu\_name|String|任务标题|是|
|4|paotuirenwu\_types|Integer|任务类型|是|
|5|paotuirenwu\_new\_money|BigDecimal|单价|是|
|6|paotuirenwu\_photo|String|封面|是|
|7|yonghu\_id|Integer|用户|是|
|8|paotuirenwu\_shouhbuoren|String|收货人|是|
|9|paotuirenwu\_phone|String|电话|是|
|10|paotuirenwu\_dizhi|String|地址|是|
|11|paotuirenwu\_text|String|备注|是|
|12|paotuirenwu\_status\_types|Integer|任务状态|是|
...
图5.1 用户信息管理页面
### 5.2 跑腿任务管理
如图5.2显示的就是跑腿任务管理页面，此页面提供给管理员的功能有：查看已发布的跑腿任务数据，修改跑腿任务，跑腿任务作废，即可删除，还进行了对跑腿任务名称的模糊查询 跑腿任务信息的类型查询等等一些条件。
